...
IMPLEMENT_SHADER_TYPE(, FComputeParticlePosCS, TEXT("/Plugin/VisOnEarth/Private/ComputeParticlePos.usf"), TEXT("MainCS"), SF_Compute);
...
void FFlowFieldRenderer::UpdateSettings(FFlowFieldSettings NewFlowFieldSettings)
{
	ENQUEUE_RENDER_COMMAND(UpdateGeoReference)(
	[this, NewFlowFieldSettings](FRHICommandListImmediate& RHICmdList)
	{
		SettingsFromGame = NewFlowFieldSettings;
	});
}
