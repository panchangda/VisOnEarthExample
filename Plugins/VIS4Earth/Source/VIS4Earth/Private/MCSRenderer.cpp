...
IMPLEMENT_GLOBAL_SHADER(FMCSShaderVS, "/Plugin/VIS4Earth/MCS.usf", "VS", SF_Vertex);
IMPLEMENT_GLOBAL_SHADER(FMCSShaderPS, "/Plugin/VIS4Earth/MCS.usf", "PS", SF_Pixel);
...
void FMCSRenderer::marchingSquare(const MCSParameters &Params,
    ...
    if (!indexBuffer.IsValid() || indexBuffer->GetSize() != bufSz) {
        ...
        indexBuffer = RHICmdList.CreateIndexBuffer(sizeof(int32), bufSz,
